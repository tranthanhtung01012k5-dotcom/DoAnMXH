...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostViewHolder> {
    ...
    // ← Đúng type, bỏ AdapterView.OnItemClickListener
    ...
    public void onBindViewHolder(@NonNull PostViewHolder holder, int position) {
        ...
        // ← Đặt ở đây, không phải trong payload
        // =========================
        ...
        holder.ivAvatar.setOnClickListener(v -> {
            if (listener != null)
                listener.onAvatarClick(post, holder.getAdapterPosition());
        });
        ...
        holder.btnRepost.setOnClickListener(v -> {
            if (listener != null)
                listener.onRepostClick(post, holder.getAdapterPosition());
        });
        holder.btnShare.setOnClickListener(v -> {
            if (listener != null)
                listener.onShareClick(post, holder.getAdapterPosition());
        });
        holder.btnMoreOptions.setOnClickListener(v -> {
            if (listener != null)
                listener.onMoreOptionsClick(post, holder.getAdapterPosition());
        });
    }

    // ← Tách riêng để tái sử dụng trong payload
    ...
    public void onBindViewHolder(@NonNull PostViewHolder holder, int position,
        ...
        if (!payloads.isEmpty() && payloads.contains("LIKE_UPDATE")) {
            ...
            // Chỉ update like UI + stats, KHÔNG đụng gì khác
            updateLikeUI(holder, post);
